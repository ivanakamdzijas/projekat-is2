...
<body>
	...
	<sf:form modelAttribute="user" action="/Agencija/auth/register"
		method="post" class="login">
		<table>
			<tr>
				<td><sf:input path="name" placeholder="Unesite ime i prezime" />
				</td>
			</tr>
			<tr>
			...
			<tr>
				<td><sf:password path="password" placeholder="Unesite sifru" /></td>
			</tr>
			<tr>
				<td><sf:input path="phone" placeholder="Unesite broj telefona" /></td>
			</tr>
			<tr></tr>
			<tr>
